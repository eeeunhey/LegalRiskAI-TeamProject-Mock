...
const errorDemos: ErrorDemo[] = [
    ...
    },
    {
        code: '401',
        title: 'Unauthorized',
        description: '인증이 필요합니다. 로그인 후 다시 시도해주세요.',
        icon: ShieldX,
    ...
    },
    {
        code: '502',
        title: 'Bad Gateway',
        description: '게이트웨이 오류입니다. 잠시 후 다시 시도해주세요.',
        icon: WifiOff,
        color: 'text-gray-500',
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div className="mb-8">
                <div className="flex items-center gap-3 mb-2">
                    ...
                    <h1 className="text-2xl font-bold text-gray-900 dark:text-white">에러 페이지 데모</h1>
                </div>
                <p className="text-gray-500 dark:text-gray-400">
                    다양한 HTTP 상태 코드에 대한 에러 페이지 예시를 확인할 수 있습니다.
                </p>
            </div>
                ...
                {errorDemos.map((error) => {
                    ...
                    return (
                        <button
                            ...
                            className={`
                p-6 rounded-xl border text-left transition-all hover:scale-105 hover:shadow-lg
                ...
                <div className="bg-white dark:bg-slate-800 rounded-2xl border border-gray-200 dark:border-slate-700 shadow-xl overflow-hidden">
                    <div className="px-6 py-4 border-b border-gray-200 dark:border-slate-700 flex items-center justify-between">
                        <h2 className="text-lg font-semibold text-gray-900 dark:text-white">
                            에러 페이지 미리보기: {selectedError.code}
                        </h2>
                        <button
                    ...
                    {/* Error Page Preview */}
                    <div className="p-12 bg-gray-50 dark:bg-slate-900">
                        <div className="text-center max-w-md mx-auto">
                            {/* Error Illustration */}
                            <div className="relative mb-8">
                                <div className={`text-[120px] font-bold leading-none select-none ${selectedError.code.startsWith('4')
                                        ? 'text-gray-100 dark:text-slate-800'
                            ...
                            <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
                                ...
                                <button className="flex items-center gap-2 px-5 py-2.5 bg-gray-100 dark:bg-slate-700 text-gray-700 dark:text-gray-200 font-medium rounded-lg hover:bg-gray-200 dark:hover:bg-slate-600 transition-colors">
                                    이전 페이지
                                </button>
                            </div>
                        </div>
            ...
            <div className="mt-8 p-6 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-xl">
                ...
                <div className="flex flex-wrap gap-3">
                    <Link
                        ...
                        className="px-4 py-2 bg-white dark:bg-slate-800 border border-blue-200 dark:border-slate-600 rounded-lg text-sm text-blue-700 dark:text-blue-300 hover:bg-blue-100 dark:hover:bg-slate-700 transition-colors"
                    >
                        404 페이지 보기 →
                    </Link>
                    <Link
