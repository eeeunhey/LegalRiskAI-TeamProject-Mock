        ...
        <div className="min-h-[calc(100vh-8rem)] flex items-center justify-center px-4">
            <div className="text-center">
                ...
                <div className="relative mb-8">
                    <div className="text-[150px] font-bold text-red-100 dark:text-red-900/30 leading-none select-none">
                        500
                    </div>
                ...
                {error?.message && (
                    <div className="mb-8 p-4 bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg text-left max-w-md mx-auto">
